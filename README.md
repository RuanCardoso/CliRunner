...
public unsafe static void Main()
{
    fixed (char* command = CliRunner.IsUnix() ? "ifconfig" : "ipconfig")
    {
        ...
        {
            // arguments: command, output, buffer_size, wait_for_exit, redirect_stdin, redirect_stdout, redirect_stderr, use_shell, create_no_window use_powershell, force_utf8
            int stdout_size = CliRunner.Run(command, stdout_ptr, buffer_size, true, false, true, true, false, true, true, false);
